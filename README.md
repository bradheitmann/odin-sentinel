...
**Portable MCP governance protocol for visible multi-agent teams: 29 tools, 18 resources, role topology, readiness gates, ODIN watchers, receipts, delegation, and closeout over stdio.**
