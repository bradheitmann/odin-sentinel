...
function onboardingGuidedSteps(): string[] {
  return [
    ...
    "Prefer the pinned pnpm command (pnpm dlx --package @bradheitmann/odin-sentinel@0.7.0 odin-sentinel-mcp); npm global install and npx are supported when pinned to the same release.",
