...
function onboardingGuidedSteps(): string[] {
  return [
    ...
    "Prefer the pinned pnpm command (pnpm dlx --package @bradheitmann/odin-sentinel@0.4.13 odin-sentinel-mcp); npm global install and npx are supported when pinned to the same release.",
