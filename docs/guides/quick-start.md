...
Expect `serverInfo.name = odin-sentinel` and `serverInfo.version = 0.4.12`.
...
| Stale MCP version | Use a pinned `@bradheitmann/odin-sentinel@0.4.12` command, restart host, and confirm `0.4.12`. |
