...
Expect `serverInfo.name = odin-sentinel` and `serverInfo.version = 0.7.1`.
...
| Stale MCP version | Use a pinned `@bradheitmann/odin-sentinel@0.7.1` command, restart host, and confirm `0.7.1`. |
